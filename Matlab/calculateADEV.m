...
loglog(tauUsed, (adevAccX), 'r', 'DisplayName', 'Avg Acc_X  (mg)','LineWidth',1);
loglog(tauUsed, (adevAccY), 'b', 'DisplayName', 'Avg Acc_Y  (mg)','LineWidth',1);
loglog(tauUsed, (adevAccZ), 'k', 'DisplayName', 'Avg Acc_Z  (mg)','LineWidth',1);
